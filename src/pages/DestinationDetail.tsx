    ...
    <div className="min-h-screen">
      ...
      <section className="py-12 bg-background">
        <div className="container mx-auto px-4">
          ...
          {/* Packages */}
          <div ref={packagesRef}>
            <h2 className="text-3xl font-heading font-bold mb-4 text-foreground uppercase tracking-tight">Available Packages</h2>
              ...
              <div className="flex flex-wrap gap-3 mb-10">
                {destination.packages.map((pkg) => (
                  <button
                    ...
                    className={`px-6 py-3 rounded-full font-bold uppercase tracking-widest text-xs transition-all duration-300 border-2 ${
                      activePkg.id === pkg.id
            ...
            <Card className="overflow-hidden border-none shadow-2xl shadow-black/5">
              <CardHeader className="bg-muted py-8 px-8">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                  <div>
                    <CardTitle className="text-3xl mb-3 font-bold font-heading uppercase tracking-tight">{activePkg.duration}</CardTitle>
                      ...
                      <div className="space-y-6">
                        {activePkg.itinerary.map((day) => (
                          <div key={day.day} className="border-l-2 border-primary pl-6 pb-6 relative">
                            <div className="absolute -left-3 top-0 w-6 h-6 rounded-full bg-primary text-white flex items-center justify-center text-sm font-extrabold">
                              {day.day}
                            </div>
